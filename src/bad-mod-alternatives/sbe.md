...
- **Poorly made features**
    ...
    - NOTE: Since we do not have access to the mod due to its paywall and obfuscation, if any of these features have been fixed, make an issue/PR to remove it from this list.
...
- While the terms "false" and "misinformation" are used, these points are not proven. The SBE developer in question makes no attempt to disprove any of the "false misinformation" being provided on this page.
